...
function optionsframework_page() {
	...
	<div class="proversion">
	  <h3>Upgrade to Pro version!</h3>
	   <a href="<?php echo esc_url('http://www.pwtthemes.com/theme/hannari-responsive-wordpress-theme'); ?>" target="_blank" class="upgradepro">Upgrade to Pro</a>
	   <a href="<?php echo esc_url('http://www.pwtthemes.com/demo/hannari'); ?>" target="_blank" class="donate">Demo</a>
	  <p>If you need assistance, please do not hesitate to <a href="<?php echo esc_url('http://www.pwtthemes.com/contact'); ?>" target="_blank">contact us</a></p>
	</div>
    <div class="logooption"><img src="<?php echo OPTIONS_FRAMEWORK_DIRECTORY; ?>images/pwt.png"/></div>
